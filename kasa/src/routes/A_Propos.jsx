...
const A_propos = () => {
    return (
      <div id="AboutUsPage">
        ...
        <DropdownButton Title='Service' Text='La bienveillance fait partie des valeurs fondatrices de Kasa. Tout comportement discriminatoir ou de perturbation du voisinage entraînera une exclusion de notre plateforme' />
